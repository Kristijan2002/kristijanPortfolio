  ...
  return (
    <div className={style.project}>
        ...
        {hovered && (
          <div className={style.hoverDiv}>
            ...
            <div>
                  ...
                  <defs>
                    ...
                    >
                      ...
                      <feBlend
                        ...
                        result="effect1_dropShadow_77_1093"
                      />
                      <feBlend
                        mode="normal"
                        in="SourceGraphic"
                        in2="effect1_dropShadow_77_1093"
                        result="shape"
                      />
                    </filter>
                  </defs>
              ...
              <a href={gitLink} target="_blank" rel="noopener">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="60"
                  height="60"
      ...
      <div className={style.desc}>
        ...
        <div className={style.tehnologies}>
          <h4>Technologies:</h4>
          <div className={style.technologyItems}>
            <div>
              <img src={teh1Img} alt={teh1} />
              <p>{teh1}</p>
            </div>
            <div>
              <img src={teh2Img} alt={teh2} />
              <p>{teh2}</p>
            </div>
            <div>
              <img src={teh3Img} alt={teh3} />
              <p>{teh3}</p>
            </div>
          </div>
        </div>
