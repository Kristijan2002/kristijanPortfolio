    ...
    <h3>Projects</h3>
        ...
        <div className={style.wrapper}>
            ...
            <div className={style.project}>
                ...
                <div className={style.desc}>
                    {/* <p><b>MARINOV DESIGN</b> - Engineered an E-Commerce web application tailored for Marinov Design, a thriving business in Ohrid. Leveraging Next.js, the platform amplifies online visibility, ensures secure transactions, and fuels revenue growth.</p> */}
                    <p className={style.tehnologies}>
                        Tehnologies: 
                        <img src="/devicon_nextjs (1).svg" alt="nextjs icon" /> NextJs
                        <img src="/vscode-icons_file-type-typescript-official (1).svg" alt="typescript icon" /> TypeScript
