...
const Header: React.FC = () => {
  ...
  <header className={style.header} id="home">
    ...
    <ul className={style.nav}>
        ...
        <li><a href="#skills" className={style.hover}>Skills</a></li>
        <li><a href="#projects" className={style.hover}>Projects</a></li>
        <li>
          <a href="/Kristijan Maksimovski CV.pdf" download="Kristijan Maksimovski CV" className={`${style.cv} ${style.nav}`}>
            CV 
